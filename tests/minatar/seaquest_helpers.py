# """Helper functions for seaquest environment."""
...
#     if diver[0:2] == [env.env.sub_x,
#               env.env.sub_y] and env.env.diver_count < 6:
...
#           env.env.divers.remove(diver)
#         elif (
#             diver[0:2] == [env.env.sub_x, env.env.sub_y]
...
#   """Update environment when player surfaces."""
...
#   env.env.diver_count -= 1
#   if env.env.ramping and (env.env.e_spawn_speed > 1
#       or env.env.move_speed > 2):
