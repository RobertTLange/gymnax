...
class MinSpaceInvaders(environment.Environment):
    ...
    def __init__(self):
        ...
        self.env_params = FrozenDict({"shot_cool_down": 5,
    ...
    def state_space(self):
        ...
        return spaces.Dict(
            {"pos": spaces.Discrete(10),
             ...
             "enemy_move_interval": spaces.Discrete(self.env_params["enemy_move_interval"]),
             "alien_move_timer": spaces.Discrete(self.env_params["enemy_move_interval"]),
             "alien_shot_timer": spaces.Discrete(self.env_params["enemy_shot_interval"]),
