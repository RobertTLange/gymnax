...
class DiscountingChain(environment.Environment):
    ...
    def reset(self, key: PRNGKey) -> Tuple[Array, dict]:
        ...
        state = {"rewards": self.env_params["rewards"],
                 "context": -1,
                 "time": 0,
                 "terminal": False}
    ...
    def observation_space(self):
        ...
        return spaces.Box(-1, self.env_params["n_actions"], (1, 2),
                          dtype=jnp.float32)
    ...
    def state_space(self):
        ...
        return spaces.Dict(
            {"rewards": spaces.Box(1, 1.1, (self.env_params["n_actions"],),
                                   dtype=jnp.float32),
             "context": spaces.Box(-1, self.env_params["n_actions"], (),
                                   dtype=jnp.float32),
